...
def function_of_ques1(df):
    #Here we have filtered the data from the data having 0hrs 0 mins 0secs duration of journey
    df_filtered = df[df['started_at']!=df['ended_at']]
    df_filtered = pd.DataFrame(df_filtered)
    #print(df_filtered)
...
df_filtered=function_of_ques1(df)
end_time = time.perf_counter()

total_runtime = end_time - start_time
print(f"Total runtime of my_function: {total_runtime:.6f} seconds")


#question1_2nd_part
def my_function_2(df):
